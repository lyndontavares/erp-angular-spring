...
public class PedidoFiltro extends FiltroWrapper
{
    ...
    public void setFiltros(List<Filtro> filtros)
    {
        ...
        for (Filtro filtro : filtros)
        {
            switch (filtro.getParametro().toLowerCase())
            {
                case "situacao":
                {
                    filtro.setValor((Object) PedidoSituacao.valueOf((String) filtro.getValor()));
                    break;
                }

                case "tipo":
                {
                    filtro.setValor((Object) PedidoTipo.valueOf((String) filtro.getValor()));
                    break;
                }
                 case "moeda":
                {
